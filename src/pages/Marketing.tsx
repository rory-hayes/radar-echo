      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-subtext mb-12 max-w-2xl mx-auto leading-relaxed"
          >
          ...
          >
            <Button size="lg" onClick={() => navigate('/auth')} className="btn-accent text-lg px-8">
              Get Started Free
            </Button>
            <Button size="lg" variant="outline" className="border-border text-primary hover:bg-muted">
              Watch Video
            </Button>
          </motion.div>
          ...
          >
            <div className="card-elevated p-8 text-left border-t-4 border-t-accent">
              <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-4">
                <Brain className="w-6 h-6 text-primary" />
              </div>
              <h3 className="text-lg font-semibold mb-2 text-primary">Real-Time Guidance</h3>
              <p className="text-subtext text-sm leading-relaxed">
                Get live suggestions on what to ask next based on your framework and conversation context.
              </p>
            </div>
            <div className="card-elevated p-8 text-left border-t-4 border-t-accent-2">
              ...
              <h3 className="text-lg font-semibold mb-2 text-primary">Framework Coverage</h3>
              <p className="text-subtext text-sm leading-relaxed">
                Track MEDDPICC, BANT, or custom frameworks automatically as the conversation unfolds.
              </p>
            </div>
            <div className="card-elevated p-8 text-left border-t-4 border-t-success">
              <div className="w-12 h-12 rounded-lg bg-success/10 flex items-center justify-center mb-4">
                <Zap className="w-6 h-6 text-success" />
              </div>
              <h3 className="text-lg font-semibold mb-2 text-primary">Instant Summaries</h3>
              <p className="text-subtext text-sm leading-relaxed">
